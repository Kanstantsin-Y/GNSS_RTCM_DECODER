...
JSON_SPEC = {
    ...
    1071 : ['GPS', 'MSM1', {ObservablesMSM,BareObservablesMSM123},  'GPS-MSM1-1071.json'],
    1072 : ['GPS', 'MSM2', {ObservablesMSM,BareObservablesMSM123},  'GPS-MSM2-1072.json'],
    1073 : ['GPS', 'MSM3', {ObservablesMSM,BareObservablesMSM123},  'GPS-MSM3-1073.json'],
    1074 : ['GPS', 'MSM4', {ObservablesMSM,BareObservablesMSM4567}, 'GPS-MSM4-1074.json'],
    1075 : ['GPS', 'MSM5', {ObservablesMSM,BareObservablesMSM4567}, 'GPS-MSM5-1075.json'],
    1076 : ['GPS', 'MSM6', {ObservablesMSM,BareObservablesMSM4567}, 'GPS-MSM6-1076.json'],
    1077 : ['GPS', 'MSM7', {ObservablesMSM,BareObservablesMSM4567}, 'GPS-MSM7-1077.json'],

    1081 : ['GLN', 'MSM1', {ObservablesMSM,BareObservablesMSM123},  'GLN-MSM1-1081.json'],
    1082 : ['GLN', 'MSM2', {ObservablesMSM,BareObservablesMSM123},  'GLN-MSM2-1082.json'],
    1083 : ['GLN', 'MSM3', {ObservablesMSM,BareObservablesMSM123},  'GLN-MSM3-1083.json'],
    1084 : ['GLN', 'MSM4', {ObservablesMSM,BareObservablesMSM4567}, 'GLN-MSM4-1084.json'],
    1085 : ['GLN', 'MSM5', {ObservablesMSM,BareObservablesMSM4567}, 'GLN-MSM5-1085.json'],
    1086 : ['GLN', 'MSM6', {ObservablesMSM,BareObservablesMSM4567}, 'GLN-MSM6-1086.json'],
    1087 : ['GLN', 'MSM7', {ObservablesMSM,BareObservablesMSM4567}, 'GLN-MSM7-1087.json'],

    1091 : ['GAL', 'MSM1', {ObservablesMSM,BareObservablesMSM123},  'GAL-MSM1-1091.json'],
    1092 : ['GAL', 'MSM2', {ObservablesMSM,BareObservablesMSM123},  'GAL-MSM2-1092.json'],
    1093 : ['GAL', 'MSM3', {ObservablesMSM,BareObservablesMSM123},  'GAL-MSM3-1093.json'],
    1094 : ['GAL', 'MSM4', {ObservablesMSM,BareObservablesMSM4567}, 'GAL-MSM4-1094.json'],
    1095 : ['GAL', 'MSM5', {ObservablesMSM,BareObservablesMSM4567}, 'GAL-MSM5-1095.json'],
    1096 : ['GAL', 'MSM6', {ObservablesMSM,BareObservablesMSM4567}, 'GAL-MSM6-1096.json'],
    1097 : ['GAL', 'MSM7', {ObservablesMSM,BareObservablesMSM4567}, 'GAL-MSM7-1097.json'],

    1101 : ['SBS', 'MSM1', {ObservablesMSM,BareObservablesMSM123},  'SBS-MSM1-1101.json'],
    1102 : ['SBS', 'MSM2', {ObservablesMSM,BareObservablesMSM123},  'SBS-MSM2-1102.json'],
    1103 : ['SBS', 'MSM3', {ObservablesMSM,BareObservablesMSM123},  'SBS-MSM3-1103.json'],
    1104 : ['SBS', 'MSM4', {ObservablesMSM,BareObservablesMSM4567}, 'SBS-MSM4-1104.json'],
    1105 : ['SBS', 'MSM5', {ObservablesMSM,BareObservablesMSM4567}, 'SBS-MSM5-1105.json'],
    1106 : ['SBS', 'MSM6', {ObservablesMSM,BareObservablesMSM4567}, 'SBS-MSM6-1106.json'],
    1107 : ['SBS', 'MSM7', {ObservablesMSM,BareObservablesMSM4567}, 'SBS-MSM7-1107.json'],

    1111 : ['QZS', 'MSM1', {ObservablesMSM,BareObservablesMSM123},  'QZS-MSM1-1111.json'],
    1112 : ['QZS', 'MSM2', {ObservablesMSM,BareObservablesMSM123},  'QZS-MSM2-1112.json'],
    1113 : ['QZS', 'MSM3', {ObservablesMSM,BareObservablesMSM123},  'QZS-MSM3-1113.json'],
    1114 : ['QZS', 'MSM4', {ObservablesMSM,BareObservablesMSM4567}, 'QZS-MSM4-1114.json'],
    1115 : ['QZS', 'MSM5', {ObservablesMSM,BareObservablesMSM4567}, 'QZS-MSM5-1115.json'],
    1116 : ['QZS', 'MSM6', {ObservablesMSM,BareObservablesMSM4567}, 'QZS-MSM6-1116.json'],
    1117 : ['QZS', 'MSM7', {ObservablesMSM,BareObservablesMSM4567}, 'QZS-MSM7-1117.json'],

    1121 : ['BDS', 'MSM1', {ObservablesMSM,BareObservablesMSM123},  'BDS-MSM1-1121.json'],
    1122 : ['BDS', 'MSM2', {ObservablesMSM,BareObservablesMSM123},  'BDS-MSM2-1122.json'],
    1123 : ['BDS', 'MSM3', {ObservablesMSM,BareObservablesMSM123},  'BDS-MSM3-1123.json'],
    1124 : ['BDS', 'MSM4', {ObservablesMSM,BareObservablesMSM4567}, 'BDS-MSM4-1124.json'],
    1125 : ['BDS', 'MSM5', {ObservablesMSM,BareObservablesMSM4567}, 'BDS-MSM5-1125.json'],
    1126 : ['BDS', 'MSM6', {ObservablesMSM,BareObservablesMSM4567}, 'BDS-MSM6-1126.json'],
    1127 : ['BDS', 'MSM7', {ObservablesMSM,BareObservablesMSM4567}, 'BDS-MSM7-1127.json'],

    1131 : ['NAVIC', 'MSM1', {ObservablesMSM,BareObservablesMSM123},  'NAVIC-MSM1-1131.json'],
    1132 : ['NAVIC', 'MSM2', {ObservablesMSM,BareObservablesMSM123},  'NAVIC-MSM2-1132.json'],
    1133 : ['NAVIC', 'MSM3', {ObservablesMSM,BareObservablesMSM123},  'NAVIC-MSM3-1133.json'],
    1134 : ['NAVIC', 'MSM4', {ObservablesMSM,BareObservablesMSM4567}, 'NAVIC-MSM4-1134.json'],
    1135 : ['NAVIC', 'MSM5', {ObservablesMSM,BareObservablesMSM4567}, 'NAVIC-MSM5-1135.json'],
    1136 : ['NAVIC', 'MSM6', {ObservablesMSM,BareObservablesMSM4567}, 'NAVIC-MSM6-1136.json'],
    1137 : ['NAVIC', 'MSM7', {ObservablesMSM,BareObservablesMSM4567}, 'NAVIC-MSM7-1137.json'],
